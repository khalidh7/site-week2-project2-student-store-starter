...
export default function Sidebar({isOpen, handleOnToggle, arrow, cart, products, change, submit, checkout, text, total, setTotal}) {
  ...
  return (
    <section className={`sidebar ${isOpen}`}>
      <div className="wrapper">
        ...
        <ShoppingCart isOpen={isOpen} cart={cart} products={products} change={change} submit={submit} checkout={checkout} text={text} total={total} setTotal={setTotal}/>
      </div>
    </section>
  )
}
